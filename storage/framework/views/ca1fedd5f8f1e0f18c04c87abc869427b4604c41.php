	...
	<footer id="contact" class="footer-area bg-slate-800 text-white font-sans-lato">
	  <div  class="flex flex-wrap footer-widget justify-between p-3 py-20 max-w-[960px] mx-auto section-padding">
	    <div class="basis-[300px] grow shrink p-5 pr-9 single-widget single-widget1">
	      <a href="/"><img style="width: 8vw;"  src="assets/images/logo/newlogo1.png" alt="" /></a>
	      <p class="mt-3 leading-normal">
		  Crafted for the perfect dining experience, Reserved Bites welcomes you to a world where flavors bloom and moments linger. With tables set, ambiance bright, and dishes prepared to perfection, every bite tells a story. 
	      </p>
	    </div>
	  ...
	  <div class="footer-copyright py-3 text-white bg-slate-900">
	    <div style="justify-content: space-around;" class="flex flex-wrap items-center max-w-[960px] mx-auto px-3 justify-between">
	      <span class="my-3 mx-5 leading-normal">
	        Copyright &copy;
	        <script>
	          document.write(new Date().getFullYear());
	        </script>
	        <a class="text-cyan-400" href="https://github.com/Asraf2asif" target="_blank">m_ahad</a> 
	        <a class="text-cyan-400" href="https://colorlib.com/wp/template/foodfun/" target="_blank"></a>
	      </span>
	      <ul class="social-icons flex flex-wrap my-3 mx-5 transition ease-in-out duration-300">
	        ...
	        <li class="mr-3 my-1 cursor-pointer border border-transparent hover:border-white hover:rounded-[50%] px-1">
	          <a style="color: white;" href="#" class="cursor-pointer"><i  class="fa-brands fa-facebook"></i></a>
	        </li>
	        <li class="mr-3 my-1 cursor-pointer border border-transparent hover:border-white hover:rounded-[50%] px-1">
