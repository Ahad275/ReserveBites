...
<nav
  ...
  <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
    <h5 class="mb-0 font-weight-medium d-none d-lg-flex">
      Welcome to ReserveBites admin dashboard!
    </h5>
    <ul class="navbar-nav navbar-nav-right ml-auto">
      <li>
        <a href="<?php echo e(route('index')); ?>" class="bedge-primary bg-amber-500 font-bold p-2.5 rounded text-white" target="_blank">Browse ReserveBites </a>
      </li>
...
</nav><?php /**PATH C:\xampp\htdocs\restaurant-site-laravel-master\resources\views/admin/partials/navbar.blade.php ENDPATH**/ ?>